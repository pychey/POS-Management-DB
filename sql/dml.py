...
for _ in range(NUM_POS_SYSTEM // BATCH_SIZE):
    ...
    print(f"Inserted {BATCH_SIZE} records into pos_system. (NOT SAVED YET)")
...
for _ in range(NUM_POS_FEATURE // BATCH_SIZE):
    ...
    print(f"Inserted {BATCH_SIZE} records into pos_feature. (NOT SAVED YET)")
...
for _ in range(NUM_PRICING // BATCH_SIZE):
    ...
    print(f"Inserted {BATCH_SIZE} records into pricing. (NOT SAVED YET)")
...
for _ in range(NUM_STORE_CLIENT // BATCH_SIZE):
    ...
    print(f"Inserted {BATCH_SIZE} records into store_client. (NOT SAVED YET)")
...
for _ in range(NUM_POS_SALE // BATCH_SIZE):
    ...
    print(f"Inserted {BATCH_SIZE} records into pos_sale. (NOT SAVED YET)")
...
for _ in range(NUM_STORE_INVENTORY // BATCH_SIZE):
    ...
    print(f"Inserted {BATCH_SIZE} records into store_inventory. (NOT SAVED YET)")
...
for _ in range(NUM_STORE_TRANSACTION // BATCH_SIZE):
    ...
    print(f"Inserted {BATCH_SIZE} records into store_transaction. (NOT SAVED YET)")
...
for _ in range(NUM_TRANSACTION_ITEM // BATCH_SIZE):
    ...
    print(f"Inserted {BATCH_SIZE} records into transaction_item. (NOT SAVED YET)")
...
for _ in range(NUM_SYSTEM_FEATURE // BATCH_SIZE):
    for _ in range(BATCH_SIZE):
        ...
        cursor.execute("""
            ...
            VALUES (%s, %s)
        """, (pos_id, feature_id))
    print(f"Inserted {BATCH_SIZE} records into system_feature. (NOT SAVED YET)")
